...
<div id="available-items-panel" class="dashboard-view-panel" style="display: none;">
    <div class="glass-panel" style="padding: 30px; margin-bottom: 24px;">
        <div class="card-header">
            ...
            <select class="form-control form-select" id="filterAvailableCategory" onchange="window.renderAllAvailableItems && window.renderAllAvailableItems()" style="max-width: 250px;">
            ...
            <div id="availableCascadingFilterContainer" style="display:none;"><span id="availableCascadingFilterLabel"></span></div>
        </div>
